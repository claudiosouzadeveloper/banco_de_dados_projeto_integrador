<html>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Alunos Matriculados <i class="fa-duotone fa-person"></i></h5>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Frequencia dos alunos<i class="fa-solid fa-people-group"></i></h5>
        <p class="card-text">Frequencia.</p>
        <a href="alunos_list.php" class="btn btn-primary">presenca</a>
      </div>
